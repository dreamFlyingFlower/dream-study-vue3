<template>
  <div class="IndexWrap">
    <el-card shadow="hover">
      <div class="InquireWrap">
        <div class="InquireList">
          <el-input size="small" v-model="moduleData.warehouseName" placeholder="仓库名称" @keyup.enter="getList"
            clearable />
    ...
    <el-table class="spareTable" :data="moduleData.tableDatas" ref="tableDatasRef" empty-text="暂无数据"
      style="width: 100%;font-size:10px" @selection-change="handleSelectionChange" :height="moduleData.theight"
      :header-cell-style="{padding:'0px'}" :cell-style="{padding:'0px'}" border fit highlight-current-row>
      <el-table-column :show-overflow-tooltip="true" align="center" width="50" type="index" label="序号" />
      <el-table-column label="" type="selection" width="45" align="center" />
      ...
      <el-table-column :show-overflow-tooltip="true" align="center" min-width="120" prop="warehouseName" label="仓库名称" />
      <el-table-column :show-overflow-tooltip="true" align="center" style="height:145px" min-width="100" prop="manager"
        label="负责人" />
      <el-table-column :show-overflow-tooltip="true" align="center" min-width="100" prop="telephone" label="联系电话" />
      <el-table-column :show-overflow-tooltip="true" align="center" min-width="120" prop="address" label="仓库地址" />
...
const getList = () => {
  api.apis.getList({
    warehouseName: moduleData.warehouseName,
...
const removeData = (rowId: number) => {
  ElMessageBox.confirm('此操作将永久删除该仓库定义,是否继续?', '提示', {
