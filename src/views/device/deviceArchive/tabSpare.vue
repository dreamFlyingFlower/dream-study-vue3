<template>
  <div>
    <div class="oprate_btn">
      <el-button size="small" class="filter-item" type="primary" @click="showDialog">
        <el-icon style="vertical-align: middle;">
          <plus />
        </el-icon>
        <span style="vertical-align: middle;">新增</span>
      </el-button>
      <el-button size="small" class="filter-item" type="primary" @click="deleteData">
        <el-icon style="vertical-align: middle;">
          <delete />
        </el-icon>
    ...
    <el-table :data="moduleData.tableDatas" ref="mainList" @selection-change="handlerSelectionChange" size="mini"
      ...
      <el-table-column show-overflow-tooltip min-width="100" align="center" label="备件编码" prop="sparePartCode" />
      <el-table-column show-overflow-tooltip min-width="120" align="center" label="备件名称" prop="sparePartName" />
      <el-table-column show-overflow-tooltip min-width="120" align="center" label="规格型号" prop="specificationModel" />
      <el-table-column show-overflow-tooltip min-width="100" align="center" label="备件类型" prop="sparePartTypeId_CN" />
      <el-table-column show-overflow-tooltip min-width="80" align="center" label="计量单位" prop="measuringUnitName" />
      <el-table-column show-overflow-tooltip min-width="100" align="center" label="库存下限" prop="inventoryFloor" />
      <el-table-column show-overflow-tooltip min-width="100" align="center" label="库存上限" prop="inventoryTop" />
    </el-table>
