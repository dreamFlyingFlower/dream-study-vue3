  ...
  >
    ...
    >
      ...
      >
        ...
        <el-table-column label="位置编码" min-width="100" align="center">
          <template v-slot:default="scope">
            <el-input
              :disabled="dialogType == 1"
              v-model="scope.row.positionalCode"
              size="small"
            ></el-input>
          </template>
        </el-table-column>
...
import { addStock } from "../../types/storehouse";
  ...
  () => {
    ...
    switch (props.dialogType) {
      ...
      default:
        ...
        addForm.outputInputTime = props.rowInfo.createTime;
        addForm.operator = props.rowInfo.operator;
        addForm.customerId = props.rowInfo.customerId;
...
const addForm = reactive<addStock>({
  outputInputTime: "",
  changeWarehouseCode: "",
  warehouseId: "",
  type: "",
