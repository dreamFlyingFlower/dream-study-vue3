  ...
  <div class="IndexWrap">
    <div class="IndexRight">
      <el-card shadow="hover">
        <div class="InquireWrap">
          <div class="InquireList">
            ...
            <el-input size="small" v-model="moduleData.slowSearch" placeholder="保养负责人" @keyup.enter="getList"
              clearable />
            <el-button size="small" type="primary" @click="getList">查询</el-button>
          </div>
          <div>
            <el-button size="small" type="primary" @click="showDialog(1, {})">添加</el-button>
            <!-- <el-button size="small" type="primary" @click="changeStatus({planStatue:'1'})">启用</el-button> -->
            <!-- <el-button size="small" type="primary" @click="changeStatus({planStatue:'2'})">停用</el-button> -->
      ...
      <el-table class="spareTable" ref="tableDatasRef" :data="moduleData.tableDatas" empty-text="暂无数据"
        ...
        <el-table-column :show-overflow-tooltip="true" align="center" min-width="80" prop="id" label="计划序号" />
        <el-table-column :show-overflow-tooltip="true" align="center" min-width="120" prop="deviceCode" label="设备编码" />
        <el-table-column :show-overflow-tooltip="true" align="center" min-width="120" prop="applicant" label="保养负责人">
        </el-table-column>
        <el-table-column :show-overflow-tooltip="true" align="center" min-width="120" prop="departmentName"
          label="部门" />
        <el-table-column :show-overflow-tooltip="true" align="center" min-width="100" prop="upkeepPlanTimeStart"
          label="计划开始时间" />
        <el-table-column :show-overflow-tooltip="true" align="center" min-width="100" prop="upkeepPlanTimeEnd"
          label="计划结束时间" />
        <el-table-column :show-overflow-tooltip="true" align="center" min-width="120" prop="lifetime" label="循环周期">
          <template v-slot:default="scope">
            {{scope.row.loopCycle + scope.row.cycleUnit}}
          </template>
        </el-table-column>
        <el-table-column :show-overflow-tooltip="true" align="center" min-width="100" prop="planStatue" label="计划状态">
          <template v-slot:default="scope">
            <el-switch v-model="scope.row.planStatue" inline-prompt active-color="#13ce66" inactive-color="#ff4949"
              active-value="1" inactive-value="0" active-text="启用" inactive-text="停用"
